...
async def mark_invite_used(code: str, email: str):
    """A kódot megjelöljük felhasználtként, hogy az admin lássa ki használta."""
...
async def revoke_invite_and_lock_user(code: str):
    """Zárolja azt a fiókot, ami ezt a kódot használta, majd törli a kódot."""
...
async def reactivate_user(email: str, new_code: str):
    """Feloldja a zárolt felhasználót egy új kóddal."""
